...
from api.models import Proveedor, Producto, Client, Venta, VentaProducto, Orden
from api.serializers import ProveedorSerializer, ProductoSerializer, ClientSerializer, VentaSerializer, VentaProductoSerializer, UserSerializer, OrdenSerializer
